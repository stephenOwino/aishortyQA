...
test.describe('User Registration', () => {
  ...
  test('should display signup page heading', async ({ page, registerPage }) => {
  ...
  test('should show all validation errors on password field focus', async ({ page, registerPage }) => {
  ...
  test('should navigate to Google signin when clicking Google button', async ({ page, registerPage }) => {
  ...
  test('should navigate to Apple signin when clicking Apple button', async ({ page, registerPage }) => {
    await registerPage.clickAppleSignIn();
    await expect(page.locator('#ac-localnav')).toContainText('Apple Account');
    await expect(page.locator('#contentheader')).toContainText('Use your Apple Account to sign in to Shorty.');
  });
